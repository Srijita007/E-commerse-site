...
<body onload="submitPayuForm()">
  ...
  <section id="header" style="height: 25%;" class="container-fluid">
    <div class="row">
      <div class="col-10 align-self-start">
        <div class="heading_1"><a href="../index.php">E-commerce Brand</a></div>
        <div class="heading_2">Created By: <b>Srijita Chakrabarty</b></div>
        <br>
      </div>
