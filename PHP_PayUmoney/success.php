...
<body>
      <button style="margin: 2% 2%; padding: 0.2% 0.4%; background-color: rgb(255, 217, 0); font-weight: bolder; border-radius: 10px; border: 2px solid black; font-size: larger;" class="register_button" onclick="window.location='../logout.php'">Home</button>
</body>
