...
$sql = "UPDATE `products` SET `p_id` = '$product_id', `product_name` = '$product_name', `P_Image` = '$file_name', `description` = '$product_desc', `category` = '$product_type', `price` = '$product_cost', `status` = '$product_status' WHERE `p_id` = '$selected_product'";
