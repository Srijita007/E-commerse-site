...
$sql = "INSERT INTO `products` (`p_id`, `product_name`, `P_Image`, `category`,  `description`, `price`, `status`) VALUES ('$product_id', '$product_name', '$file_name', '$product_type', '$product_desc',  '$product_cost', '$product_status')";
